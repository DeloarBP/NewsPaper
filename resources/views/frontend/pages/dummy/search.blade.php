		...
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-md-9"> <!-- Blog Post Area Start -->
				...
				<div class="blog-lists"> <!-- Blog Post List Area Start -->
					...
					<h3>You are Searching : <span>"Fun"</span> </h3> <!-- Main Title -->

					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single17.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
							<p>Lorem ipsum dolor sit amet, consectetuer  <mark>fun</mark> adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.</p>
					...
					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single12.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
							<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo  <mark>fun</mark> ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.</p>
							<span> 	<a href=""><i class="fa fa-folder-open-o"></i> National</a> 
									<a href=""><i class="fa fa-clock-o"></i> 8:11pm</a> 
									<a href=""><i class="fa fa-commenting-o"></i> 0 Comments</a>		 
							</span>
					...
					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single13.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil,  <mark>fun</mark> Ryan’s Standing Still Lofty</h3></a>
					...
					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single14.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
							<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.  <mark>fun</mark> Donec quam felis, ultricies nec.</p>
							<span> 	<a href=""><i class="fa fa-folder-open-o"></i> National</a> 
									<a href=""><i class="fa fa-clock-o"></i> 8:11pm</a> 
									<a href=""><i class="fa fa-commenting-o"></i> 0 Comments</a>		 
							</span>
					...
					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single15.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
							<p>Lorem ipsum dolor sit amet, consectetuer <mark>fun</mark>  adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.</p>
							<span> 	<a href=""><i class="fa fa-folder-open-o"></i> National</a> 
					...
					<div class="blog-list"> <!-- Blog List Item Start -->
						<div class="post-thumb"> <img src="images/fea-single16.png"> </div>
						<div class="blog-list-loop">
							<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
							<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. <mark>fun</mark> Donec quam felis, ultricies nec.</p>
							<span> 	<a href=""><i class="fa fa-folder-open-o"></i> National</a> 
