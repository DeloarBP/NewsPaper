	...
	<div class="container"> <!-- Content Body Area Start --> 
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-md-9"> <!-- Blog Post Area Start -->
				...
				<div class="author-n-sub-box author-box-m-fix"> <!-- Author Box Container Start -->
					<div class="row">

						<div class="hidden-xs col-xs-2 col-sm-2 col-md-2">
							<div class="author-img">
								<a href=""><img src="images/author-img-big.png"></a>
							</div>
						</div>	
				...
				<div class="blog-lists"> <!-- Blog Post List Area Start -->
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-lg-6"> <!-- Blog List Item Start -->
							<div class="blog-gird">
								<div class="post-thumb-gird hover-img"> <iframe width="100%" height="211px" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/114360394&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe> </div>
								<div class="blog-list-loop-gird">
									<a href=""><h3>Amid House Turmoil, Ryan’s Standing Still Lofty</h3></a>
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.</p>
									<span> 	<a href=""><i class="fa fa-folder-open-o"></i> National</a> 
